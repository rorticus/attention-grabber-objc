...
- (void)addWebSocket:(WebSocket *)ws
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"HTTPUpdated" object:self];
}

-(void) sendToAllWebSockets:(NSString *)message {
    [webSocketsLock lock];
    for(WebSocket *socket in webSockets) {
